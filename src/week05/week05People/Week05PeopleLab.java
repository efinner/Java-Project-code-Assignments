...
public class Week05PeopleLab {
	...
	public static void main(String[] args) {
		 ...
		 */
Person person= new Person("Denali", "Kia", 2);
person.describe();
		 ...
		 *
		 */
		Person person2=new Person("Hannah", "Finner", 35);
		person2.describe();
		 ...
		 */
	String olderPerson= whosOlder(person,person2);
	 ...
	 * Method -- Question 3:
	 */
public static String whosOlder(Person person1, Person person2) {
