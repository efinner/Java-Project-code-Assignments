...
public class week05MathOperationsLab {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println(executeOperation(addition, num1, num2));
		System.out.println("\t2b - Subtraction:  ");
		/*
		 * Put call to method using subtraction here
		 */System.out.println(executeOperation(subtraction, num1, num2));
		 ...
		 */
		System.out.println(executeOperation(multiply, num1, num2));
		 ...
		 */
	        ...
	        System.out.println(executeOperation(divide, num1, num2));
	 ...
	 * Method -- Question 3:
	 */
	public static double executeOperation(MathOperation operation, double num1, double num2) {
